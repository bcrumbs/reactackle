...
const HeaderDemoRouteSnippet0 = () => (
  <div>
    <Header
      condensedHeaderHeight={40}
      condenses
      keepCondensedHeader
      behavior="fixed"
      backgroundColor="#3d4766"
      backgroundImage={'http://demo.hermesthemes.com/castello/' +
      'files/2013/06/tuscany-farmhouse-belvedere-at-dawn-san' +
      '-quirico-dorcia-italy-1500x900.jpg'}
    >
      <HeaderRegion verticalAlign="center">
        <HeaderTitle colorScheme="light">
          <div style={{ paddingTop: '60px' }}>
            Auto-hide header with visible part
          </div>
        </HeaderTitle>
      </HeaderRegion>
    </Header>
